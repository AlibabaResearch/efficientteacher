...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False):
        ...
        elif self.magicmind: # Cambricon
            mm_out = []
            self.inputs[0].from_numpy(im.numpy().transpose(0,2,3,1)) #nhwc
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        # types = [pt, jit, onnx, xml, engine, coreml, saved_model, pb, tflite, edgetpu, tfjs, paddle, magicmind]
